...
class Constants {
	...
	static enum ActionAccessResult {
		ACTION_ACCESS_RESULT_SUCCESS(0),
		ACTION_ACCESS_RESULT_HARDWARE_FAULT(1),
		ACTION_ACCESS_RESULT_TEMPORARY_FAILURE(2),
		ACTION_ACCESS_RESULT_READ_WRITE_DENIED(3),
		ACTION_ACCESS_RESULT_OBJECT_UNDEFINED(4),
		ACTION_ACCESS_RESULT_OBJECT_CLASS_INCONSISTENT(9),
		ACTION_ACCESS_RESULT_OBJECT_UNAVAILABLE(11),
		ACTION_ACCESS_RESULT_TYPE_UNMATCHED(12),
		ACTION_ACCESS_RESULT_SCOPE_OF_ACCESS_VIOLATED(13),
		ACTION_ACCESS_RESULT_DATA_BLOCK_UNAVAILABLE(14),
		ACTION_ACCESS_RESULT_LONG_ACTION_ABORTED(15),
		ACTION_ACCESS_RESULT_NO_LONG_ACTION_IN_PROGRESS(16),
		ACTION_ACCESS_RESULT_OTHER_REASON(250);
		
		int val;
		
		ActionAccessResult(int val) {
			this.val = val;
		}
	}
